...
class Game:
    def __init__(self):
        ...
        self.hud = build_hud(self.ui_batch); self.hud["status"].text = "Press ENTER on Start screen to begin"
        self.start_diffs, self.start_diff_idx, self.start_view = ["Easy","Medium","Hard"], 0, "Local"
        self.start_title = text.Label("Mission Setup", x=PLAY_W_PX//2, y=WINDOW_HEIGHT//2+80,
